...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/arpi/rpi4pad/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/arpi/rpi4pad/bluetooth/vnd_rpi4.txt

BOARD_SEPOLICY_DIRS := \
    device/arpi/rpi4pad/sepolicy

DEVICE_MANIFEST_FILE := device/arpi/rpi4pad/manifest.xml
